...
public class StatisticsDisplay implements DisplayElement, Observer {
	...
	@Override
	public void display() {
		System.out.println("StatisticsDisplay统计avg/max/min," + temperature + "/" + temperature + "/" + temperature);
	}

	@Override
	public void update(String temperature, String humidity, String pressure, Object arg) {
		if (arg != null)
			System.out.println("StatisticsDisplay:" + arg.getClass().getCanonicalName());
