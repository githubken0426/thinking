...
+function (a) {
    ...
    var d = function (a, b, c) {
        ...
        var b = "alert", d = "4.0.0-alpha.3", g = "bs.alert", h = "." + g, i = ".data-api", j = a.fn[b], k = 150,
        ...
        var b = "button", d = "4.0.0-alpha.3", f = "bs.button", g = "." + f, h = ".data-api", i = a.fn[b],
        ...
        var b = "carousel", d = "4.0.0-alpha.3", g = "bs.carousel", h = "." + g, i = ".data-api", j = a.fn[b], k = 600,
            l = 37, m = 39, n = {interval: 5e3, keyboard: !0, slide: !1, pause: "hover", wrap: !0}, o = {
                ...
                return e(i, [{
                    ...
                    key: "_getItemByDirection", value: function (a, b) {
                        var c = a === p.NEXT, d = a === p.PREVIOUS, e = this._getItemIndex(b), f = this._items.length - 1,
                            g = d && 0 === e || c && e === f;
                    ...
                    key: "_slide", value: function (b, c) {
                        var d = this, e = a(this._element).find(s.ACTIVE_ITEM)[0],
        ...
        var b = "collapse", d = "4.0.0-alpha.3", g = "bs.collapse", h = "." + g, i = ".data-api", j = a.fn[b], k = 600,
        ...
        var b = "dropdown", d = "4.0.0-alpha.3", g = "bs.dropdown", h = "." + g, i = ".data-api", j = a.fn[b], k = 27,
            l = 38, m = 40, n = 3, o = {
                HIDE: "hide" + h,
                HIDDEN: "hidden" + h,
                SHOW: "show" + h,
        ...
        var b = "modal", d = "4.0.0-alpha.3", g = "bs.modal", h = "." + g, i = ".data-api", j = a.fn[b], k = 300,
            l = 150, m = 27, n = {backdrop: !0, keyboard: !0, focus: !0, show: !0},
            o = {backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean", show: "boolean"}, p = {
                HIDE: "hide" + h,
                HIDDEN: "hidden" + h,
                SHOW: "show" + h,
                SHOWN: "shown" + h,
        ...
        var b = "scrollspy", d = "4.0.0-alpha.3", g = "bs.scrollspy", h = "." + g, i = ".data-api", j = a.fn[b],
        ...
        if (void 0 === window.Tether) throw new Error("Bootstrap tooltips require Tether ");
        var b = "tooltip", d = "4.0.0-alpha.3", g = "bs.tooltip", h = "." + g, i = a.fn[b], j = 150, k = "bs-tether",
            l = {
                animation: !0,
    ...
    (function (a) {
        var f = "popover", h = "4.0.0-alpha.3", i = "bs.popover", j = "." + i, k = a.fn[f],
