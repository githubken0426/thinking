...
public class CADSystem extends Shape {
	 ...
	 * constructor CADSystem.dispose() Erasing Triangle Shape dispose Erasing Circle
	 * Shape dispose Erasing Line: 2, 4 Shape dispose Erasing Line: 1, 1 Shape
	 * dispose Erasing Line: 0, 0 Shape dispose Shape dispose
	 */// :~
